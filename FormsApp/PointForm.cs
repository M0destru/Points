    ...
    public partial class PointForm : Form
    {
        ...
        private void btnCreate_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < points.Length; i++)
                points[i] = rnd.Next(3) % 2 == 0? new Point() : new Point3D(rnd.Next(10));
        ...
        private void btnSerialize_Click(object sender, EventArgs e)
        {
            if (points == null)
            {
                MessageBox.Show("Create points first", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }
                ...
                switch (Path.GetExtension(dlg.FileName))
                {
                    ...
                    case ".json":
                        var jf = new JsonSerializer 
                            { TypeNameHandling = TypeNameHandling.Auto }; // с сохранением информации о типе
